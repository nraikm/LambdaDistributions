...
compiled PDF are under `output/pdf/for_this_guy/finite_group_sigma_mgf/` in the
same family layout.

Run the regression suite from the repository root:

```sh
python -m pytest -q for_this_guy/finite_group_sigma_mgf/test_verification.py
```
