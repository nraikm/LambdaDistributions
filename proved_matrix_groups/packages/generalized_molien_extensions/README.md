...
```bash
.venv/bin/python -m for_this_guy.generalized_molien_extensions.run_all
.venv/bin/python -m pytest for_this_guy/generalized_molien_extensions/test_verification.py -q
