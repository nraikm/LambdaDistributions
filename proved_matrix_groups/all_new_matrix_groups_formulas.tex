...
remain in \path{lambda_distributions/proofs} and
\path{lambda_distributions/dists}. The common object is the generalized
...
This section indexes every canonical note merged from
\path{proved_matrix_groups/anthology_sections/new_dists/}.
...
Sources live in \path{lambda_distributions/proofs/},
\path{lambda_distributions/dists/}.  All repository
...
\path{lambda_distributions/proofs/} and \path{output/pdf/lambda_distributions/proofs/} are compatibility
