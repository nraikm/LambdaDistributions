...
def _():
    ...
    folder = (Path(__file__).resolve().parents[1] / "lambda_distributions/proofs/matrix_group_formula_verification/h3_reflection/h3_reflection_verification.py").parent
