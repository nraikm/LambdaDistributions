...
def _():
    ...
    import sys
    repo_root = str((Path(__file__).resolve().parents[1] / "lambda_distributions/proofs/matrix_group_formula_verification/classical_compact/notebook.py").parents[3])
    if repo_root not in sys.path:
        sys.path.insert(0, repo_root)
    from lambda_distributions.proofs.matrix_group_formula_verification.classical_compact.verification import run_suite
    return mo, run_suite
