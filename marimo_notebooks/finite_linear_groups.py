...
def _():
    ...
    root = (Path(__file__).resolve().parents[1] / "proved_matrix_groups/packages/finite_lie_type_permutation_actions/linear_groups_verification.py").parents[2]
    if str(root) not in sys.path:
        sys.path.insert(0, str(root))
    from for_this_guy.finite_lie_type_permutation_actions.verification_core import linear_suite
