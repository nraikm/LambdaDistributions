...
def _():
    ...
    import marimo as mo
    root = (Path(__file__).resolve().parents[1] / "lambda_distributions/proofs/association_scheme_permutation_representations/hamming/notebook.py").parents[3]
    if str(root) not in sys.path:
        sys.path.insert(0, str(root))
    from lambda_distributions.proofs.association_scheme_permutation_representations.hamming.verification import run_suite
    return mo, run_suite
