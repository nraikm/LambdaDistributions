...
def _():
    ...
    folder = (Path(__file__).resolve().parents[1] / "proved_matrix_groups/packages/matrix_group_formula_verification/representation_variants/representation_variants_verification.py").parent
