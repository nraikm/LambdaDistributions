...
```sh
.venv/bin/python -m lambda_distributions.proofs.local_unitary_tensor_products.verification
.venv/bin/python -m pytest -q lambda_distributions/proofs/local_unitary_tensor_products/test_verification.py
```
