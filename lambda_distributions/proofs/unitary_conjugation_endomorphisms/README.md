...
```bash
python3 lambda_distributions/proofs/unitary_conjugation_endomorphisms/unitary_conjugation_core.py
python3 -m pytest lambda_distributions/proofs/unitary_conjugation_endomorphisms/test_verification.py
marimo edit marimo_notebooks/unitary_conjugation.py
```

The proof source and compiled PDF live in
`output/pdf/lambda_distributions/proofs/unitary_conjugation_endomorphisms/`.
