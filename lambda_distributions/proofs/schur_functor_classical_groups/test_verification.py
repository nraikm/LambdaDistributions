from lambda_distributions.proofs.schur_functor_classical_groups.common import schur_dimension
from lambda_distributions.proofs.schur_functor_classical_groups.orthogonal.verification import (
    run_suite as run_orthogonal,
)
from lambda_distributions.proofs.schur_functor_classical_groups.symplectic.verification import (
    run_suite as run_symplectic,
)
from lambda_distributions.proofs.schur_functor_classical_groups.unitary.verification import (
