...
```bash
.venv/bin/python -m lambda_distributions.proofs.schur_functor_classical_groups.unitary.verification
.venv/bin/python -m lambda_distributions.proofs.schur_functor_classical_groups.orthogonal.verification
.venv/bin/python -m lambda_distributions.proofs.schur_functor_classical_groups.symplectic.verification
```
