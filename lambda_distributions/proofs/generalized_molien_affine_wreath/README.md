...
- Proof source and compiled PDF:
  `../../output/pdf/lambda_distributions/proofs/generalized_molien_affine_wreath/affine_groups/`
...
- Proof source and compiled PDF:
  `../../output/pdf/lambda_distributions/proofs/generalized_molien_affine_wreath/wreath_products/`
...
```sh
.venv/bin/python lambda_distributions/proofs/generalized_molien_affine_wreath/affine_groups/verification.py
.venv/bin/python lambda_distributions/proofs/generalized_molien_affine_wreath/wreath_products/verification.py
