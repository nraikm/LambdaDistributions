...
```sh
pytest -q lambda_distributions/proofs/association_scheme_permutation_representations/test_verification.py
```
...
`output/pdf/lambda_distributions/proofs/association_scheme_permutation_representations/`.
